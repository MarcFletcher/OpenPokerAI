namespace PokerBot.Definitions
{
    ...
    public struct Player
    {
        ...
        {
            this.name = name; this.remainingChipsValue = remainingChipsValue; actionEntered = false; action = PokerAction.Check; amount = 0; sittingOut = false;
            holeCard1 = Card.NoCard; holeCard2 = Card.NoCard;
        ...
        {
            holeCard1 = card1; holeCard2 = card2;
        }
