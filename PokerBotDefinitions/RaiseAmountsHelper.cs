...
namespace PokerBot.Definitions
{
    public static class RaiseAmountsHelper
    {
        ...
        {
            if (additionalRaiseAmountToScale < 0) throw new Exception("additionalRaiseAmountToScale cannot be less than 0.");
            if (minAdditionalRaiseAmount > maxAdditionalRaiseAmount) throw new Exception("minAdditionalRaiseAmount should be less than maxAdditionalRaiseAmount!");

            double potAmount_Double = (double)(currentPotAmount);

            if (potAmount_Double > (double)(BigPotBBMultiplierLimit * bigBlind)) potAmount_Double = (double)(BigPotBBMultiplierLimit * bigBlind);
            if (potAmount_Double < (double)(SmallPotBBMultiplierLimit * bigBlind)) potAmount_Double = (double)(SmallPotBBMultiplierLimit * bigBlind);
        ...
        {
            if (scaledAdditionalRaiseAmount < 0) throw new Exception("scaledAdditionalRaiseAmount cannot be less than 0.");
            if (minAdditionalRaiseAmount > maxAdditionalRaiseAmount) throw new Exception("minAdditionalRaiseAmount should be less than maxAdditionalRaiseAmount!");
            ...
            if (result < minAdditionalRaiseAmount) result = minAdditionalRaiseAmount;
            if (result > maxAdditionalRaiseAmount) result = maxAdditionalRaiseAmount;
