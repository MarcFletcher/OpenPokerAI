...
namespace Encog.Solve.Genetic
{
    ...
    public class MateWorker : IEngineTask
    {
        ...
        /// <summary>
        /// We have a possible GATracker for tracking the iteration
        /// </summary>
        private GATracker.MatedElement matedElement;
        ...
        public MateWorker(IGenome mother, IGenome father,
                IGenome child1, IGenome child2, GATracker.MatedElement matedElement)
        {
            this.mother = mother;
            this.father = father;
            this.child1 = child1;
            this.child2 = child2;
            this.matedElement = matedElement;
        }
        ...
        public void Run()
        {
            mother.Mate(father, child1, child2, matedElement);
        }
    }
}
