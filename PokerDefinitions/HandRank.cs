...
namespace PokerBot.Definitions
{
  ...
  public static class HandRank
  {
    ...
    public static int GetHandRank(Card card1, Card card2, Card card3, Card card4, Card card5, Card card6, Card card7)
    {
      ...
      if (card1 == Card.Unseen)
      { unseenCard = true; card1 = card7; card7 = Card.Unseen; }
      if (card2 == Card.Unseen)
      { unseenCard = true; card2 = card7; card7 = Card.Unseen; }
      if (card3 == Card.Unseen)
      { unseenCard = true; card3 = card7; card7 = Card.Unseen; }
      if (card4 == Card.Unseen)
      { unseenCard = true; card4 = card7; card7 = Card.Unseen; }
      if (card5 == Card.Unseen)
      { unseenCard = true; card5 = card7; card7 = Card.Unseen; }
      if (card6 == Card.Unseen)
      { unseenCard = true; card6 = card7; card7 = Card.Unseen; }
      if (card7 == Card.Unseen)
      { unseenCard = true; }
